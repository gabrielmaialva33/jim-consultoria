...
<section id="editais" class="bg-gray-50 py-20 lg:py-28">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
      ...
      <a
        href="/grants"
        class="px-8 py-3 text-lg rounded-xl border-2 border-brand-200 text-brand-700 hover:bg-brand-50 hover:border-brand-300 transition-all duration-300 inline-flex items-center gap-2"
      >
        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
